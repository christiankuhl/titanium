pub fn vendor(vendor_id: u16) -> &'static str {
    match vendor_id {
        ...
        0x0059 => "Tiger Jet Network Inc. (Wrong ID)<td>Real TJN ID is e159, but they got it wrong several times ",
        0x0070 => "Hauppauge computer works Inc.",
        0x0071 => "Nebula Electronics Ltd.",
        0x0095 => "Silicon Image, Inc. (Wrong ID)",
        0x00a7 => "Teles AG (Wrong ID)<td>Wrong ID used in subsystem ID of the TELES.S0/PCI 2.x ISDN ada",
        0x0100 => "nCipher Security",
        0x0123 => "General Dynamics",
        0x0128 => "Dell (wrong ID)",
        0x018a => "LevelOne<td>018a is not LevelOne but there is a board misprogra",
        0x01de => "Oxide Computer Company",
        0x0200 => "Dell (wrong ID)<td>probably misprogrammed Intel Atom C2338 on Dell 0K8Y0N b",
        0x021b => "Compaq Computer Corporation<td>021b is not Compaq but there is a board misprogra",
        0x0270 => "Hauppauge computer works Inc. (Wrong ID)",
        0x0291 => "Davicom Semiconductor, Inc. (Wrong ID)",
        0x02ac => "SpeedStream<td>SpeedStream is Efficient Networks, Inc, a Siemens Com",
        ...
        0x1002 => "Advanced Micro Devices, Inc. [AMD/ATI]<td>nee ATI Technologies, ",
        0x1003 => "ULSI Systems",
        ...
        0x101d => "Maxim Integrated Products<td>ID for Newly Acquired Storage Products from Vit",
        ...
        0x104a => "STMicroelectronics<td>nee SGS Thomson Microelectro",
        0x104b => "BusLogic",
        ...
        0x1056 => "ICL",
        0x1057 => "Motorola<td>Motorola made a mistake and used 1507 instead of 1057 in some chips. Please look at the 1507 entry as well when updating t",
        ...
        0x1079 => "I-Bus",
        0x107a => "NetWorth",
        0x107b => "Gateway, Inc.<td>formerly Gateway 2000 / acquired by Acer ",
        ...
        0x108a => "SBS Technologies<td>Formerly Bit3 Computer C",
        ...
        0x1095 => "Silicon Image, Inc.<td>nee CMD Technology",
        0x1096 => "Alacron",
        ...
        0x10b9 => "ULi Electronics Inc.<td>Split off ALi Corporation in ",
        ...
        0x10cc => "Mai Logic Incorporated<td>nee Mentor ARC",
        0x10cd => "Advanced System Products, Inc",
        0x10ce => "Radius",
        0x10cf => "Fujitsu Limited.<td>nee Citicorp",
        ...
        0x1103 => "HighPoint Technologies, Inc.<td>nee Triones Technologies, ",
        ...
        0x1112 => "Osicom Technologies Inc<td>Also claimed to be RNS or Rockwell International, current PCISIG records list Os",
        ...
        0x111d => "Microsemi / PMC / IDT<td>now owned by Microchip Techno",
        0x111e => "Eldec",
        0x111f => "Precision Digital Images",
        0x1120 => "Dell EMC<td>formerly EMC Corpora",
        0x1121 => "Zilog",
        ...
        0x112b => "Heidelberger Druckmaschinen AGHeidelberger Druckmaschinen AG<td>nee Linotype - Hel",
        ...
        0x1148 => "SysKonnect<td>Nee Schneider &amp; ",
        ...
        0x11a9 => "InnoSys Inc.",
        0x11aa => "Actel",
        0x11ab => "Marvell Technology Group Ltd.<td>Nee Galileo Technology, ",
        ...
        0x11c1 => "LSI Corporation<td>nee Agere Systems nee Lucent Microelectro",
        ...
        0x11fe => "Pepperl+Fuchs<td>nee Comtrol, ",
        ...
        0x1232 => "GPT Limited",
        0x1233 => "Bus-Tech, Inc.",
        0x1235 => "SMART Modular Technologies<td>nee Risq Modular Systems, ",
        ...
        0x123e => "Simutech, Inc.",
        0x123f => "LSI Logic<td>nee C-Cube Microsystems / acquired by Magnum Semicondu",
        0x1240 => "Marathon Technologies Corp.",
        0x1241 => "DSC Communications",
        0x1242 => "JNI Corporation<td>Formerly Jaycor Networks, ",
        0x1243 => "Delphax",
        0x1244 => "AVM GmbH<td>Audio-Visuelles Marketing und Computersys",
        0x1245 => "A.P.D., S.A.",
        ...
        0x1258 => "Gilbarco, Inc.",
        0x1259 => "Allied Telesis<td>nee Allied Telesyn Internati",
        ...
        0x12b8 => "Korg",
        0x12b9 => "3Com Corp, Modem Division<td>Nee US Robo",
        0x12ba => "BittWare, Inc.",
        ...
        0x12d8 => "Pericom Semiconductor<td>acquired by Diodes ",
        0x12d9 => "Aculab PLC",
        ...
        0x1307 => "Measurement Computing<td>Nee ComputerBo",
        ...
        0x1344 => "Micron Technology Inc<td>nee Crucial Techno",
        0x1345 => "Arescom Inc",
        0x1347 => "Odetics",
        ...
        0x1351 => "Sonix Inc",
        0x1353 => "dbeeSet Technology<td>nee Vierling Communication SAS, nee Thales Id",
        ...
        0x140b => "Abaco Systems, Inc.<td>Formerly RAMiX, GE Fanuc, GE Intelligent Platf",
        ...
        0x1412 => "VIA Technologies Inc.<td>Nee IC Ensemble ",
        0x1413 => "Addonics",
        ...
        0x1435 => "RTD Embedded Technologies, Inc.<td>Nee Real Time Devices US ",
        ...
        0x144b => "Verint Systems Inc.<td>nee Loronix Information Systems ",
        ...
        0x14ab => "Siemens Industry Software Inc.<td>nee Mentor Graphics C",
        ...
        0x14c1 => "MYRICOM Inc.<td>now owned by CSP, ",
        0x14c2 => "DTK Computer",
        ...
        0x14d9 => "Alliance Semiconductor Corporation<td>Formerly SiPackets, Inc., formerly API NetWorks, Inc., formerly Alpha Processor, ",
        ...
        0x14ec => "Agilent Technologies<td>nee ACQ",
        ...
        0x1507 => "Motorola ?? / HTEC<td>Should be HTEC Ltd, but there are no known HTEC chips and 1507 is already used by mistake by Motorola (see vendor ID 10",
        ...
        0x1527 => "SOLECTRON",
        0x1528 => "ACKSYS",
        0x1529 => "ON Semiconductor<td>nee American Microsystems",
        ...
        0x1542 => "Concurrent Real-Time<td>nee VIVID Technology ",
        ...
        0x158f => "Ditect Coop",
        0x1590 => "Hewlett Packard Enterprise<td>formerly 3PAR ",
        0x1591 => "ARN",
        ...
        0x1657 => "Cavium QLogic<td>nee Brocade Communications Systems, ",
        0x165a => "Epix Inc",
        0x165c => "Gidel Ltd.<td>Gidel Reconfigurable Compu",
        0x165d => "Hsing Tech. Enterprise Co., Ltd.",
        0x165f => "Linux Media Labs, LLC",
        0x1661 => "Worldspace Corp.",
        0x1668 => "Actiontec Electronics Inc",
        0x166d => "Broadcom Corporation<td>Formerly SiByte, ",
        ...
        0x168c => "Qualcomm Atheros<td>nee Atheros Communications, ",
        0x1695 => "EPoX Computer Co., Ltd.",
        0x169c => "Netcell Corporation",
        0x169d => "Club-3D VB (Wrong ID)<td>The right ID is 196d, but they got it nibble-swapped in 2",
        ...
        0x16ca => "CENATEK Inc",
        0x16cd => "Advantech Co. Ltd<td>nee Innocore Gaming Ltd., nee Densitron Gaming Ltd., a division of Densitron Technolo",
        0x16ce => "Roland Corp.",
        0x16d5 => "Acromag, Inc.",
        ...
        0x1725 => "Vitesse Semiconductor<td>Seems to be a 2nd ID for Vitesse Semicondu",
        0x172a => "Accelerated Encryption",
        0x1734 => "Fujitsu Technology Solutions<td>nee Fujitsu Siemens Computers ",
        ...
        0x1796 => "Research Centre Juelich<td>also used by Struck Innovative Systeme for joint developm",
        0x1797 => "Intersil Techwell<td>nee Techwell, ",
        0x1799 => "Belkin",
        0x179a => "id Quantique",
        ...
        0x17c0 => "Wistron Corp.",
        0x17c2 => "Newisys, Inc.",
        0x17cb => "Qualcomm<td>nee Airgo Networks, ",
        0x17cc => "NetChip Technology, Inc",
        0x17cd => "Cadence Design Systems, Inc.",
        0x17cf => "Z-Com, Inc.",
        0x17d3 => "Areca Technology Corp.",
        0x17d5 => "Exar Corp.<td>nee Neterion Inc., previously S2io ",
        0x17db => "Cray Inc",
        0x17de => "KWorld Computer Co. Ltd.",
        0x17df => "Dini Group",
        0x17e4 => "Sectra AB",
        0x17e6 => "MaxLinear<td>nee Entropic Communications ",
        ...
        0x182f => "Broadcom<td>Strange vendor ID used by BCM5785 when in RAID ",
        ...
        0x18b8 => "Ammasso",
        0x18bc => "GeCube Technologies, Inc.<td>formally Info-Tek C",
        0x18c3 => "Micronas Semiconductor Holding AG",
        0x18c8 => "Cray Inc<td>Nee Octigabay Sy",
        0x18c9 => "ARVOO Engineering BV",
        0x18ca => "XGI Technology Inc. (eXtreme Graphics Innovation)",
        0x18d2 => "Sitecom Europe BV (Wrong ID)<td>should be ",
        0x18d4 => "Celestica",
        ...
        0x1954 => "One Stop Systems, Inc.<td>nee Curtis, ",
        0x1957 => "Freescale Semiconductor Inc",
        0x1958 => "Faster Technology, LLC.",
        0x1959 => "PA Semi, Inc",
        0x1966 => "Orad Hi-Tec Systems",
        0x1969 => "Qualcomm Atheros<td>nee Atheros Communications, Inc. nee Attansic Technology C",
        0x196a => "Sensory Networks Inc.",
        0x196d => "Club-3D BV",
        0x196e => "PNY",
        0x1971 => "AGEIA Technologies, Inc.",
        0x1974 => "Star Electronics GmbH &amp; Co. KG<td>nee Eberspaecher Electro",
        0x1976 => "TRENDnet",
        0x1977 => "Parsec",
        ...
        0x1a56 => "Rivet Networks<td>nee Bigfoot Networks, now owned by I",
        ...
        0x1ab6 => "CalDigit, Inc.",
        0x1ab8 => "Parallels, Inc.<td>Parallels VM virtual dev",
        0x1ab9 => "Espia Srl",
        ...
        0x1ae8 => "Basler AG<td>nee Silicon Software ",
        0x1ae9 => "Wilocity Ltd.",
        0x1aea => "Alcor Micro",
        0x1aec => "Wolfson Microelectronics",
        0x1aed => "SanDisk<td>nee Fusio",
        0x1aee => "Caustic Graphics Inc.",
        0x1af4 => "Red Hat, Inc.<td>nee Qumranet, ",
        0x1af5 => "Netezza Corp.",
        ...
        0x1b39 => "sTec, Inc.<td>now owned by HGST (a Western Digital subsidi",
        0x1b3a => "Westar Display Technologies",
        0x1b3e => "Teradata Corp.",
        0x1b40 => "Schooner Information Technology, Inc.",
        0x1b47 => "Numascale AS<td>also used by some PROXIM (14b7) devices erroneo",
        ...
        0x1c2c => "Silicom Denmark<td>previously Fiberb",
        0x1c32 => "Highland Technology, Inc.<td>Used on V120 VME Crate Contro",
        0x1c33 => "Daktronics, Inc",
        0x1c36 => "Annapurna Labs Ltd.",
        0x1c3b => "Accensus, LLC",
        0x1c44 => "Enmotus Inc",
        0x1c58 => "HGST, Inc.<td>A Western Digital Subsid",
        0x1c5c => "SK hynix",
        0x1c5f => "Beijing Memblaze Technology Co. Ltd.",
        0x1c63 => "Science and Research Centre of Computer Technology (JSC &quot;NICEVT&quot;)<td>http://www.nicevt.ru/ (in Russ",
        ...
        0x1d18 => "RME",
        0x1d1d => "CNEX Labs",
        0x1d21 => "Allo<td>CEM Solutions Pvt. ",
        ...
        0x1d87 => "Rockchip Electronics Co., Ltd<td>nee Fuzhou Rockchip Electronics Co.,",
        0x1d8f => "Enyx",
        ...
        0x1e38 => "Blaize, Inc<td>nee Thinci,",
        0x1e39 => "MEDION AG<td>https://www.medion.",
        ...
        0x1e94 => "Calian SED<td>aka SED Sys",
        ...
        0x1fc0 => "Ascom (Finland) Oy<td>nee Tumsa",
        0x1fc1 => "QLogic, Corp.<td>nee PathScale,",
        ...
        0x43bc => "Tiger Lake-H PCIe Root Port #5",
        ...
        0x4651 => "TXIC<td>Can&#39;t find any information on this com",
        ...
        0x5700 => "Netpower",
        0x5845 => "X-ES, Inc.<td>alternately Extreme Engineering Solutions, ",
        ...
        0x6688 => "Zycoo Co., Ltd",
        0x6900 => "Red Hat, Inc.<td>nee Qumr",
        0x7063 => "pcHDTV",
        0x7284 => "HT OMEGA Inc.",
        ...
        0x807d => "Asustek Computer, Inc.<td>Wrong ID used in subsystem ID of AsusTek PCI-USB2 PCI c",
        ...
        0x8686 => "SAP<td>nee Sca",
        0x8800 => "Trigem Computer Inc.",
        0x8820 => "Stryker Corporation",
        0x8866 => "T-Square Design Inc.",
        0x8888 => "Silicon Magic",
        0x8912 => "TRX",
        0x8c4a => "Winbond<td>8c4a is not Winbond but there is a board misprogra",
        0x8e0e => "Computone Corporation",
        0x8e2e => "KTI",
        0x9004 => "Adaptec",
        0x9005 => "Adaptec<td>Acquired by Microchip Techno",
        0x907f => "Atronics",
        ...
        0x9710 => "MosChip Semiconductor Technology Ltd.<td>nee Netmos Techno",
        0x9850 => "3Com (wrong ID)<td>Subsystem ID on a 3c985B-SX network ",
        0x9902 => "Stargen Inc.",
        ...
        0xb10b => "Uakron PCI Project<td>Not registered offici",
        0xb1b3 => "Shiva Europe Limited",
        0xb1d9 => "ATCOM Technology co., LTD.",
        0xbd11 => "Pinnacle Systems, Inc. (Wrong ID)<td>Pinnacle should be 11bd, but they got it wrong several times ",
        ...
        0xdeda => "XIMEA<td>formerly SoftHard Technology ",
        0xe000 => "Winbond",
        ...
        0xea60 => "RME<td>The main chip of all these devices is by Xilinx -&gt; It could also be a Xilinx",
        ...
        0xf043 => "ASUSTeK Computer Inc. (Wrong ID)<td>Found on M2N68-AM Motherb",
        0xf05b => "Foxconn International, Inc. (Wrong ID)",
        0xf15e => "SiFive, Inc.",
        0xf1d0 => "AJA Video",
        0xf5f5 => "F5 Networks, Inc.",
        0xf849 => "ASRock Incorporation (Wrong ID)<td>Subsystem ID for PATA controller on nForce motherb",
        0xfa57 => "Interagon AS",
        0xfab7 => "Fabric7 Systems, Inc.",
        0xfebd => "Ultraview Corp.",
        0xfeda => "Broadcom Inc<td>Nee Epi",
        0xfede => "Fedetec Inc.",
        0xfffd => "XenSource, Inc.",
        0xfffe => "VMWare Inc (temporary ID)<td>Used in some old VMWare products before they got a real ID assi",
